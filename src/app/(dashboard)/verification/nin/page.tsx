...
export default function NINVerificationPage() {
  ...
  const handleVerify = async () => {
    ...
    if (balance < PREMIUM_NIN_PRICE) {
      showError(`Insufficient balance. You need ${formatCurrency(PREMIUM_NIN_PRICE)} but have ${formatCurrency(balance)}`);
      return;
    }
          ...
          <div className={styles.section}>
            ...
            <div className={styles.servicesGrid}>
              <button className={`${styles.serviceCard} ${styles.selected}`}>
                ...
                <div className={styles.servicePrice}>{formatCurrency(PREMIUM_NIN_PRICE)}</div>
              </button>
            </div>
          </div>
              ...
              <div className={styles.formFooter}>
                <div className={styles.priceBreakdown}>
                  <div className={styles.priceRow}>
                    ...
                    <span>{formatCurrency(PREMIUM_NIN_PRICE)}</span>
                  </div>
                  <div className={styles.priceTotal}>
                    <span>Total</span>
                    <strong>{formatCurrency(PREMIUM_NIN_PRICE)}</strong>
                  </div>
                </div>
